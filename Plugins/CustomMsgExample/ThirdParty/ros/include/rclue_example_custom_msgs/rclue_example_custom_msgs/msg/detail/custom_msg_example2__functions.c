...
rclue_example_custom_msgs__msg__CustomMsgExample2__init(rclue_example_custom_msgs__msg__CustomMsgExample2 * msg)
{
  ...
  // str_field2
  if (!rosidl_runtime_c__String__init(&msg->str_field2)) {
    rclue_example_custom_msgs__msg__CustomMsgExample2__fini(msg);
    return false;
  }
  // int_field
  // float_field
  // example_msg
  if (!rclue_example_custom_msgs__msg__CustomMsgExample__init(&msg->example_msg)) {
    rclue_example_custom_msgs__msg__CustomMsgExample2__fini(msg);
    return false;
  }
  return true;
...
rclue_example_custom_msgs__msg__CustomMsgExample2__fini(rclue_example_custom_msgs__msg__CustomMsgExample2 * msg)
{
  ...
  // str_field2
  rosidl_runtime_c__String__fini(&msg->str_field2);
  // int_field
  // float_field
  // example_msg
  rclue_example_custom_msgs__msg__CustomMsgExample__fini(&msg->example_msg);
}
...
rclue_example_custom_msgs__msg__CustomMsgExample2__are_equal(const rclue_example_custom_msgs__msg__CustomMsgExample2 * lhs, const rclue_example_custom_msgs__msg__CustomMsgExample2 * rhs)
{
  ...
  // example_msg
  if (!rclue_example_custom_msgs__msg__CustomMsgExample__are_equal(
  ...
  rclue_example_custom_msgs__msg__CustomMsgExample2 * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->str_field2), &(output->str_field2)))
  {
    return false;
  }
  // int_field
...
rclue_example_custom_msgs__msg__CustomMsgExample2__create()
{
  ...
  rclue_example_custom_msgs__msg__CustomMsgExample2 * msg = (rclue_example_custom_msgs__msg__CustomMsgExample2 *)allocator.allocate(sizeof(rclue_example_custom_msgs__msg__CustomMsgExample2), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rclue_example_custom_msgs__msg__CustomMsgExample2));
  bool success = rclue_example_custom_msgs__msg__CustomMsgExample2__init(msg);
  if (!success) {
...
rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__init(rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rclue_example_custom_msgs__msg__CustomMsgExample2 * data = NULL;

  if (size) {
    data = (rclue_example_custom_msgs__msg__CustomMsgExample2 *)allocator.zero_allocate(size, sizeof(rclue_example_custom_msgs__msg__CustomMsgExample2), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rclue_example_custom_msgs__msg__CustomMsgExample2__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rclue_example_custom_msgs__msg__CustomMsgExample2__fini(&data[i - 1]);
      }
...
rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__fini(rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rclue_example_custom_msgs__msg__CustomMsgExample2__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * array = (rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence *)allocator.allocate(sizeof(rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__init(array, size);
  if (!success) {
...
rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__destroy(rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence__are_equal(const rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * lhs, const rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rclue_example_custom_msgs__msg__CustomMsgExample2__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rclue_example_custom_msgs__msg__CustomMsgExample2__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rclue_example_custom_msgs__msg__CustomMsgExample2);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rclue_example_custom_msgs__msg__CustomMsgExample2 * data =
      (rclue_example_custom_msgs__msg__CustomMsgExample2 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rclue_example_custom_msgs__msg__CustomMsgExample2__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rclue_example_custom_msgs__msg__CustomMsgExample2__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rclue_example_custom_msgs__msg__CustomMsgExample2__copy(
